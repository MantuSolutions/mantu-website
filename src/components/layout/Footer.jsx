export default function Footer() {
  ...
  return (
    <footer className="bg-black border-t border-white/10 pt-8 md:pt-15 pb-6 md:pb-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] h-[150px] bg-blue-600/10 blur-[100px] rounded-t-full pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-8 mb-8 md:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3">
              <li><a href="#hero" className="text-gray-400 hover:text-blue-600 transition-colors text-xs md:text-sm">Início</a></li>
              <li><a href="#solucao" className="text-gray-400 hover:text-blue-600 transition-colors text-xs md:text-sm">A Solução IA</a></li>
              <li><a href="#comparacao" className="text-gray-400 hover:text-blue-600 transition-colors text-xs md:text-sm">Comparativo</a></li>
              <li><a href="#download" className="text-gray-400 hover:text-blue-600 transition-colors text-xs md:text-sm">Download do App</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-6 md:pt-8 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
          <p className="text-gray-500 text-[10px] md:text-xs list-none">
            &copy; {currentYear} Mantu. Todos os direitos reservados.
            <li><a href="https://github.com/MantuCo/mantu-website" className="text-gray-500 text-[10px] md:text-xs hover:text-blue-600 transition-colors">­Apoiar no GitHub</a></li>
          </p>
        </div>
      </div>
    </footer>
