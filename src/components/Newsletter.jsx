...
export default function Newsletter() {
  ...
  if (state.succeeded) {
    return (
      <div className="text-center p-6 md:p-8 bg-orange-500/10 border border-orange-500/20 rounded-2xl">
        <h3 className="text-xl md:text-2xl font-bold text-orange-500">Bem-vindo ao GearMind! ⚡</h3>
  ...
  return (
    <div className="w-full max-w-xl mx-auto px-4 md:px-0">
      <form onSubmit={handleSubmit} className="relative group">
        <div className="flex flex-col sm:flex-row gap-2 md:gap-3 p-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl transition-all focus-within:border-orange-500/50">
          ...
          <button 
            ...
            className="bg-orange-500 hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed text-black font-extrabold px-6 md:px-8 py-3 rounded-xl transition-all active:scale-95 shadow-[0_0_20px_rgba(249,115,22,0.3)] whitespace-nowrap text-sm md:text-base"
          >
