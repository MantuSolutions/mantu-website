export default function Problema() {
  return (
    <section className="relative pt-5 md:pt-10 pb-5 md:pb-10">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8 max-w-5xl mx-auto">
          ...
          <div className="group bg-white/5 border border-white/10 p-5 md:p-8 rounded-2xl hover:bg-white/10 hover:border-orange-500/30 transition-all duration-300">
            <div className="w-12 md:w-14 h-12 md:h-14 bg-red-500/10 border border-red-500/20 rounded-xl flex items-center justify-center mb-3 md:mb-6">
              {/* Ícone de Dinheiro/Desperdício */}
              <svg className="w-6 md:w-7 h-6 md:h-7 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="group bg-white/5 border border-white/10 p-5 md:p-8 rounded-2xl hover:bg-white/10 hover:border-orange-500/30 transition-all duration-300">
            <div className="w-12 md:w-14 h-12 md:h-14 bg-orange-500/10 border border-orange-500/20 rounded-xl flex items-center justify-center mb-3 md:mb-6">
              {/* Ícone de Alerta/Motor */}
              <svg className="w-6 md:w-7 h-6 md:h-7 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
